...
class RestApiTest(APITestCase):
    ...
    def test_testruns_status(self):
        ...
        self.assertEqual(10, data[-1]['tests_pass'])
        self.assertEqual(8, data[-1]['tests_fail'])
        self.assertEqual(0, data[-1]['tests_xfail'])
        self.assertEqual(0, data[-1]['tests_skip'])
        self.assertEqual(0, data[-1]['metrics_summary'])
